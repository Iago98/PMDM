...
public class DateTime {
     ...
     */
    public DateTime(String dateTime, String timeInfo, String gmtInfo,String latLong)
    {
        if ( dateTime == null
                || dateTime.isEmpty() )
        {
    ...
    /** @return the Lat Long info, as a string. */
