...
public class ResponseParser {
    ...
    private static final String LONGI_TAG = "lng";
    ...
    private void parse(InputStream is)
    {
        ...
        try {
            ...
            latLong= "Lat: "+json.getInt(LAT_TAG)+". Long: "+ json.getInt(LONGI_TAG)+".";
            // GMT info
            ...
            this.data = new DateTime( time, timeInfo, gmtInfo,latLong );
